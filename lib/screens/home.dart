import 'package:foddy/assets/assets.dart';
import 'package:foddy/screens/cart.dart';
import 'package:foddy/screens/product_detail.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Column(
          ...
          children: [
            Text(
              activeIndex == 0 ? "Welcome Rahul" : "My Cart",
...
class PopularProducts extends StatelessWidget {
  ...
  const PopularProducts({super.key, required this.changeActiveIndex});
...
class RecentlyAddedProducts extends StatelessWidget {
  final Function changeActiveIndex;
  const RecentlyAddedProducts({super.key, required this.changeActiveIndex});
...
class _ProductCardState extends State<ProductCard> {
  void successSnackBar(message) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        backgroundColor: const Color.fromARGB(255, 132, 27, 22),
        content: Row(
          children: [
            const Icon(
